...
export default {
  ...
  description:
    ...
    '\nВыделенная скоростная линия интернета, Wi-Fi. Из техники: микроволновка, варочная панель, встроенный холодильник, ' +
    '\nHD ЖК телевизор 32 дюйма с USB медиаплеером (можно смотреть фильмы с флешки), кофемашина, компактная итальянская стиральная машина под раковиной. ' +
    '\nВся сантехника стильная, мебель вся дизайнерская: стулья и кресло, табуреты, 2 дивана 3-х местных, много декора, модные ковры, ' +
    '\nподвесное кресло шведское в маленькой лоджии, хорошая уютная кухня и т. п. В санузле стеклянная душевая перегородка с подсветкой, ' +
    '\nтропический душ встроен в потолок с подсветкой, душ с термостатом, освещение перед зеркалом регулируется сенсорным диммером. ' +
    '\nХороший австрийский ламинат под массивную доску. Кого ищем: интеллигентных граждан РФ от 28 лет и старше. ' +
